    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                return Response({"detail": "No user with this email address exists."}, status=status.HTTP_400_BAD_REQUEST)
            ...
            reset_url = f"http://localhost:8001{reverse('reset-password', args=[uid, token])}"
